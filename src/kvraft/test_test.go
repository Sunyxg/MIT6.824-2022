...
// 调用客户端完成get/put/append操作，并在log中记录
...
// 一个或多个客户端在一段时间内向一组服务器提交Append/Get操作，结束后检查所有被追加的值是否存在
// unreliable被设置，则RPC可能会失败
// crash被设置，则服务器会崩溃并重新启动
// partitions被设置，则会在服务器与客户端上同时重新划分网络
